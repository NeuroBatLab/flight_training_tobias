...
%create gui
h_fig = figure('name','Bat $cope Tracking','Position',[65 143 300 500],'ToolBar','none','DockControls','on','MenuBar','none');  
...
h_run = uicontrol(h_fig,'Style','togglebutton','String','Run','units','normalized',...
    'Position',[.01 .9 .3 .1],'Callback',@run_batScope_tracking,'fontsize',10,'fontweight','b','tag','run');
