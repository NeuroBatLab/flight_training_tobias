function record_audio_tobias(varargin)
...
h_directory_aud = uicontrol(h_fig,'Style','edit','String','C:\tobias\\audio','units','normalized',...
...
h_run_aud = uicontrol(h_fig,'Style','togglebutton','String','Run','units','normalized',...
    'Position',[.01 .9 .3 .1],'Callback',@run_rec_audio,'fontsize',10,'fontweight','b','tag','run');
...
input_channels = 0:7; %0-5 are the microphones and 6-7 TTL inputs
